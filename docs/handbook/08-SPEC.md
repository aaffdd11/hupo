...
| **Z4** | **桌面是屏幕最下面那一条**；聊天浮窗浮在它**上面**，两者之间也是同一个边距 | 主人 2026-09-22：*"首先，页面底部是一个桌面。聊天窗口是一个左右上下 margin 为 30 的浮窗，有阴影。"* ⇒ 原来那版"桌面 = 整页底图 + 浮窗盖在上面"**读不出"底部是桌面"**（最大化时你只看得到一圈 30px 的边）。契约：`docs/dev/52-DESKTOP.md` |
...
| 浮窗边距 | **四边 30** | 🔴 **2026-09-22 主人改**（原：左右 10 / 下 10 / 上 12）—— 见 §六 Z4。⚠️ 下边距量的是**浮窗底到桌面顶** |
| 浮窗圆角 / 气泡圆角 | **18** / **12** | 沿用 |
