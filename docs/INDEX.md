...
| **聊天窗口重做（第四批：外观与字号 —— 用户能调的那两样）** | [`dev/119-APPEARANCE-AND-FONT.md`](dev/119-APPEARANCE-AND-FONT.md)（契约：三档外观与那条字号的规则 · 本机怎么存 · 怎么往下传 · 设置那两行 · **改了哪些面 / 哪些故意留在暖白纸那套 / 整机暗色为什么要主人先拍一句** · 判据与读数）＋ 研究 [`dev/115-DSH-WINDOW-PARITY.md`](dev/115-DSH-WINDOW-PARITY.md) | 动「亮暗外观 / 跟随系统 / 聊天字号 / 聊天窗口配色」之前 |
