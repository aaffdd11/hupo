...
| 4 | 🟡 **`dsh` 进镜像 ✅ 做完了**（②-1，2026-09-21：镜像 130→385MB，容器里 `dsh --version` = `0.1.5-rc.1`、空 `DSH_HOME` 能起 sdk、人格层挂得上、服务照常 200 —— 见 `34-CONTAINER.md` §七） · **换手到 uid 1000 ⬜ 还没** · **root 小代理持 key ⬜ 还没** | 换手要改 spawn；代理 + UDS 要写 |
