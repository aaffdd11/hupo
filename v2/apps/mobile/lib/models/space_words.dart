...
///    "怎么回桌面"这件事**屏幕上没字了** —— 出口只剩聊天条最前面那颗 home。
///    对第一次进来的人，那是一颗"看起来像图标、其实能点"的东西
///    ⇒ 进屏时在上面浮一句白话，3.5 秒后自己走。
/// ⚠️ 它不是按钮、不是待办：**一个字都不许改成"点击此处"那种口气**。
const String homeHintWords = '点击这里可以回到桌面哦';
